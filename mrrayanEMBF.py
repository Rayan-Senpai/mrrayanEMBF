#!usr/bin/python3.7
#Author: Rayan-XD ©2022
#contact: +6285852768706
...
def banner():
	...
	print(cyan('  / __(_)  |/  / _ )/ __/ ',bold=True),green('Author : Rayan-XD',bold=True))
	print(cyan(' _\ \/ / /|_/ / _  / _/	  ',bold=True),green('Contact: +6285852768706',bold=True))
...
try:
	...
	toket.close()
		...
		try:
			...
			print("[!] masukin yg bener lah kntol")
			exit()
...
def update():
	...
	if os.name in ['nt','win32']:
		os.system('cd .. & rd /s/q mrrayanEMBF')
		os.system('cd .. & git clone https://github.com/Rayan-Senpai/mrrayanEMBF)
		exit()	
	else:
		os.system('cd ..;rm -rf mrrayanEMBF')
		os.system('cd ..;git clone https://github.com/Rayan-Senpai/mrrayanEMBF')
		exit()
